...
#        return lemmas
    ...
    def tokenize(self):
        ...
        for d in nlp.pipe(docs):
            lemmas = [self.__filter_word(doc.lemma_) for doc in d if not (doc.is_punct or doc.is_space 
                      or doc.dep_==('det' or 'aux' or 'poss' or 'prep' or 'nsubj' or 'nsubjpass' or 'dobj')
                      or doc.lemma_ in chars)]
